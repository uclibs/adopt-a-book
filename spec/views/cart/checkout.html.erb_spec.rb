  ...
  describe 'renders checkout page' do
    context 'when the products have dedication and recognition' do
      ...
      it 'renders adopter form and products in the cart (title along with dedication and recognition)' do
        render
        assert_select 'h3', text: 'Adopter information form'
        ...
        assert_select 'div>strong', text: 'Adopted books:'
        assert_select 'strong', text: 'Title', count: 2
        assert_select 'div>strong>label', text: 'Dedication:'.to_s, count: 2
        assert_select 'div>strong>label', text: 'Recognition:'.to_s, count: 2
